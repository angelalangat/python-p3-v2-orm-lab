...
class Employee:
    ...
    def reviews(self):
        from review import Review  # Import Review at the top to keep code cleaner

        """Return list of reviews associated with current employee"""
        return Review.get_all_by_employee_id(self.id)  # Use a method in Review to fetch associated reviews
